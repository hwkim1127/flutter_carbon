...
/// Gray 90 Theme implementation of [CarbonSyntaxThemeData].
class G90SyntaxThemeData extends CarbonSyntaxThemeData {
  const G90SyntaxThemeData()
    : super(
        ...
        syntaxString: CarbonPalette.gray10,
        ...
        syntaxMacroName: CarbonPalette.gray10,
