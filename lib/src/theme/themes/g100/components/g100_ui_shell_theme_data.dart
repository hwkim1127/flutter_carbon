...
class G100UIShellThemeData extends CarbonUIShellThemeData {
  const G100UIShellThemeData()
      : super(
          // Header
          headerBackground: CarbonPalette.gray100,
          headerBorder: CarbonPalette.gray90,
          ...
          sideNavDivider: CarbonPalette.gray90,
          // Panel
