...
/// Gray 100 Theme implementation of [CarbonChatThemeData].
class G100ChatThemeData extends CarbonChatThemeData {
  const G100ChatThemeData()
    : super(
        chatPromptBackground: CarbonPalette.gray100,
        chatPromptBorderStart: CarbonPalette.gray90,
        chatPromptBorderEnd: const Color(0x00262626), // gray90 (0.0)
        ...
        chatButton: CarbonPalette.blue40, // linkPrimary
