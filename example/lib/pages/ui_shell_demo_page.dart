...
class _UIShellDemoPageState extends State<UIShellDemoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // CarbonUIShell no longer provides a Material ancestor (it's
    // Material-free since v2 wave 3); this demo's content uses Material
    // widgets (ListTile, Radio, IconButton), so the page supplies one.
    return Material(
          ...
          child: ListView(
            children: [
              ...
              Container(
                ...
                // Keeps the ListTiles' ink painting above this decorated
                // background (debug assertion otherwise).
                child: Material(
                  type: MaterialType.transparency,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              onTap: () => setState(
                                () => _collapseMode =
                                    CarbonSideNavCollapseMode.fixed,
                              ),
                            ),
                            ListTile(
                              title: Text(
                              ...
                              onTap: () => setState(
                                () => _collapseMode =
                                    CarbonSideNavCollapseMode.rail,
                              ),
                            ),
                            ListTile(
                              title: Text(
